...
console.log("hi js up and running!"),(new WOW).init();const navbarOption=()=>window.innerWidth<=425?{navbar:{add:!1}}:{},navbar=window.innerWidth<=425?{navbar:{add:!1}}:{};window.onload=function(){window.innerWidth<748&&new Mmenu("#my-menu",{extensions:{all:["position-right","pagedim-black","listview-justify","border-none"],"(max-width: 425px)":["fullscreen"]},...navbar},{transitionDuration:"100px"})};
